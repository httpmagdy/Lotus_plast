...
class ReservePreviewPlumber extends StatefulWidget {
  @override
  _ReservePreviewPlumberState createState() => _ReservePreviewPlumberState();
}

class _ReservePreviewPlumberState extends State<ReservePreviewPlumber> {
  final GlobalKey<FormState> globalKeyPreview = GlobalKey<FormState>();

  // GetUserPosition _getUserPosition = Get.put(GetUserPosition());
  AddPreviewPlumberProvider _addPreviewProvider =
      Get.put(AddPreviewPlumberProvider());
