...
import '../../repository/Inspector_Repo/get_plumber_by_code_repo.dart';
...
class GetPlumberByCodeProvider extends GetxController {
  ...
  Future<GePlumberAccountModel> plumberByCode() async {
    try {
      GePlumberAccountModel _data = await _plumberByCodeRepo
          .getPlumberByCodeRepo(code: codeController.text);
      return _data;
    } catch (e) {
      throw e;
    }
